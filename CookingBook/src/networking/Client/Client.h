...
public:
    ...
    Client();
    ~Client();
    bool RecvFile(const std::string& sPath,const std::string& sFileName);
    bool CheckIP();
    ...
    void SendFile(const std::string& sPath,const std::string &sFileName);
    //User operations
    ...
    bool AddRecipeToFavorites(const int iRecipeId);
    ...
    bool DeleteRecipeFromFavourites(const int iRecipeId);
    //Requests:
